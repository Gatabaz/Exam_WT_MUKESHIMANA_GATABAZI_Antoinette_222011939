...
<br><br><br><br>
  <div class="container">
    <a href='/counselingplatform/assessment.php' class="add">New Add</a> <br>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>
                  <a href='/counselingplatform/assessmentedd.php?assessment_id={$row['assessment_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/counselingplatform/assessmentdelete.php?assessment_id={$row['assessment_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
