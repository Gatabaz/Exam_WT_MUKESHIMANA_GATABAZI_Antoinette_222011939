...
<br><br> <br><br>
 <div class="container">
    <div class="form-box">
      <form action="clientadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Clients</h2>
        <p id="result"></p>  
...
?>
  ...
  <div class="input-box">
<label  class="leb" for="gender">Gender</label>
<input class="input" type="gender" id="gender" name="gender" placeholder="Enter gender" required> 
</div> 

 <div class="input-box">
          <label class="leb" for="yearbirth"> Year of Birth:</label>
         <select class="se" type="text" name="yearbirth" id="yearbirth" style="  width: 100%; height: 45px;" >
             <?php
