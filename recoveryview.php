...
<header>
  ...
  <div class="container">
    <a href='/counselingplatform/recovery.php' class="add">New Add</a> <br>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>
                  <a href='/counselingplatform/recoveryedit.php?recovery_id={$row['recovery_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/counselingplatform/recoverydelete.php?recovery_id={$row['recovery_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
