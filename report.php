...
<br><br>
 <div class="container">
    <div class="form-box">
      <form action="reportadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Report</h2>
        <p id="result"></p>  
...
?>
  ...
  <div class="input-box">
<label  class="leb" for="reportText">Text report</label>
<input class="input" type="text" id="reportText" name="reportText" placeholder="Enter reportText" required> 
</div> 
 <div class="input-box">
<label  class="leb" for="reportdate">Report Date</label>
<input class="input" type="date" id="reportdate" name="reportdate" placeholder="Enter reportdate" required> 
</div> 
       <div class="button">
