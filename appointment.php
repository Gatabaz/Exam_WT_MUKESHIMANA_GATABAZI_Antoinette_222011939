...
<br><br><br>
 <div class="container">
    <div class="form-box">
      <form action="appointmentadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Appointment</h2>
        <p id="result"></p>  
...
?>
  ...
  <div class="input-box">
<label  class="leb" for="starttime">Start Time</label>
<input class="input" type="date" id="starttime" name="starttime" placeholder="Enter starttime" required> 
</div> 
 <div class="input-box">
<label  class="leb" for="endtime">End Time</label>
<input class="input" type="date" id="endtime" name="endtime" placeholder="Enter endtime" required> 
</div> 
       <div class="button">
