...
<header>
 ...
 <div class="container">
    <div class="form-box">
      <form action="profileadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Profile</h2>
        <p id="result"></p>  
...
?>
  ...
  <div class="input-box">
<label  class="leb" for="firstname">First Name</label>
<input class="input" type="text" id="firstname" name="firstname" placeholder="Enter firstname" required> 
</div> 

<div class="input-box">
<label  class="leb" for="lastname">Last Name</label>
<input class="input" type="text" id="lastname" name="lastname" placeholder="Enter lastname" required>
</div> 

 <div class="input-box">
  <label class="leb" for="birthDay">Birth Day</label>
   <input type="date" required name="birthDay" placeholder="Enter birthday" >
       </div> 

        <div class="input-box">
        <label class="leb" for="Country">Country</label> 

          <input type="text" required  name="country" placeholder="Enter Country" >
        </div>

        <div class="input-box">
        <label class="leb" for="city">City</label>
          <input type="text" required name="city" placeholder="Enter city" >
        </div>

        <div class="input-box">
       <label  class="leb" for="telephone">Telephone</label>
       <input class="input" type="text" id="telephone" name="telephone" placeholder="Enter telephone" required>
	</div>

        <div class="button">
          <input type="submit" value="Save" onclick="validation()" class="btn"> <br> 
