        ...
        <ul class="navigation">
          <li><a href="home.php">Home</a></li>
            ...
            <div class="dropdown-contents">
              ...
              <a href="appoinstmentview.php">Appointment Table</a>
...
<br><br>
  <div class="container">
    <a href='/counselingplatform/report.php' class="add">New Add</a> <br>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>
                  <a href='/counselingplatform/reportedit.php?report_id={$row['report_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/counselingplatform/reportdelete.php?report_id={$row['report_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
