...
$errorMessage = "";
$client_id = $counselor_id = $starttime = $endtime = "";

if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    // Check if appointment_id is set in GET parameters
    ...
    if (empty($appointment_id) || empty($client_id) || empty($counselor_id) || empty($starttime) || empty($endtime)) {
        $errorMessage = "All fields are required!";
    } else {
        // Use prepared statements to prevent SQL injection
        $sql = "UPDATE appointment SET client_id = ?, counselor_id = ?, starttime = ?, endtime = ? WHERE appointment_id = ?";
        $stmt = $connection->prepare($sql);
        $stmt->bind_param("sssii", $client_id, $counselor_id, $starttime, $endtime, $appointment_id);
...
<head>
    ...
    <title>Update About appointment</title>
    <script>
...
<center>
    ...
    <form method="POST" onsubmit="return confirmUpdate();">
        ...
        <div>
            ...
            <input class="em" readonly type="text" name="starttime" value="<?php echo $starttime; ?>" placeholder="Enter start time">
        </div>
        <div>
            <label for="endtime">End Time</label>
            <input class="em" readonly type="text" name="endtime" value="<?php echo $endtime; ?>" placeholder="Enter end time">
        </div>
        <div>
