...
<br><br><br>
  <div class="container">
    <a href='/counselingplatform/appointment.php' class="add">New Add</a> <br>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>
                  <a href='/counselingplatform/appointmentedit.php?appointment_id={$row['appointment_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/counselingplatform/appointmentdelete.php?appointment_id={$row['appointment_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
