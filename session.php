        ...
        <ul class="navigation">
          <li><a href="home.php">Home</a></li>
            ...
            <div class="dropdown-contents">
              ...
              <a href="appoitmentview.php">Appointment Table</a>
...
<br><br>
 <div class="container">
    <div class="form-box">
      <form action="seadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Session</h2>
        <p id="result"></p>  
...
?>
  ...
  <div class="input-box">
<label  class="leb" for="duration_minutes">Duration Minutes</label>
<input class="input" type="text" id="duration_minutes" name="duration_minutes" placeholder="Enter duration_minutes" required> 
</div> 
 <div class="input-box">
<label  class="leb" for="notesText">Note Text</label>
<input class="input" type="text" id="notesText" name="notesText" placeholder="Enter notesText" required> 
</div> 
       <div class="button">
          <input type="submit" value="Store" onclick="validation()" class="btn"><br><br>
