...
<br><br>
  <div class="container">
    <a href='/counselingplatform/session.php' class="add">New Add</a> <br>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>
                  <a href='/counselingplatform/sessionedit.php?session_id={$row['session_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/counselingplatform/sessiondelete.php?session_id={$row['session_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
