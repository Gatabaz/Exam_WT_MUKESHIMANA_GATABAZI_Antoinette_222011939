...
<br><br>
 <div class="container">
    <div class="form-box">
      <form action="payadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Payment</h2>
        <p id="result"></p>  
...
<input class="input" type="text" id="amount" name="amount" placeholder="Enter amount" required> 
</div> 
 
       <div class="button">
          <input type="submit" value="Pay now" onclick="validation()" class="btn"> <br>
