...
<header>
    <div class="header">
     ...
     <br><br>
  <div class="container">
    <a href='/counselingplatform/profile.php' class="add">New Add</a> <br>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>
                  <a href='/counselingplatform/profileedit.php?profile_id={$row['profile_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/counselingplatform/profiledelete.php?profile_id={$row['profile_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
