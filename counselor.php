...
<head>
	...
	<link rel="stylesheet" type="text/css" href="Counselor.css">
  <style>
...
<br><br>
 <div class="container">
    <div class="form-box">
      <form action="Counseloradd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Counselor</h2>
        <p id="result"></p>  
...
<input class="input" type="telephone" id="telephone" name="telephone" placeholder="Enter telephone" required> 
</div> 

<div class="input-box">
<label  class="leb" for="specialization">Specialization</label>
<input class="input" type="text" id="specialization" name="specialization" placeholder="Enter specialization" required>
</div> 
       <div class="button">
