...
<br><br>
  <div class="container">
    <a href='/counselingplatform/counselor.php' class="add">New Add</a> <br>
          ...
          while ($row = $result->fetch_assoc()) {
            echo "
              <tr>
                ...
                <td>
                  <a href='/counselingplatform/counseloredit.php?counselor_id={$row['counselor_id']}' class='btn btn-primary'>Edit</a>
                </td>
                <td>
                  <a href='/counselingplatform/counselordelete.php?counselor_id={$row['counselor_id']}' class='btn btn-danger'>Delete</a>
                </td>
              </tr>
            ";
          }
    ...
    <h2><marquee class="bu">WELCOME TO ONLINE SUBSTANCE COUNSELING ABUSE PLATFORM</marquee></h2>
  </div>
</body>
</html>