...
<br><br><br><br>
 <div class="container">
    <div class="form-box">
      <form action="assessmentadd.php" method="POST" name="Formfill" onsubmit="return validation" onsubmit=" return confirmInsert()">
        <h2 class="hi">Assessment</h2>
        <p id="result"></p>  
...
?>
   ...
   <div class="input-box">          
    <label class="label">Counselor Id</label>
    <select name="counselor_id" id="counselor_id" class="input"> 
<?php
$query = "SELECT counselor_id,specialization FROM counselors";
$result = $connection->query($query);
...
echo "<option value=\"$counselor_id\">$counselor_id $specialization</option>";
}
}
?>
</select><br>
  ...
  <div class="input-box">
<label  class="leb" for="assessmentDate">Assessment Date</label>
<input class="input" type="date" id="assessmentDate" name="assessmentDate" placeholder="Enter assessmentDate" required> 
</div> 
 <div class="input-box">
<label  class="leb" for="score">Score</label>
<input class="input" type="text" id="secore" name="score" placeholder="Enter score" required> 
</div> 
 <div class="input-box">
<label  class="leb" for="result">Result</label>
<input class="input" type="text" id="result" name="result" placeholder="Enter result" required> 
</div> 
       <div class="button">
          <input type="submit" value="Store" onclick="validation()" class="btn"> <br>
