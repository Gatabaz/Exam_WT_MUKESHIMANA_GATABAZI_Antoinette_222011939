...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    // Check if client_id is set in GET parameters
    ...
    if (empty($client_id) || empty($client_id) || empty($user_id) || empty($gender) || empty($yearbirth) || empty($telephone)) {
        $errorMessage = "All fields are required!";
    } else {
        // Use prepared statements to prevent SQL injection
        $sql = "UPDATE clients SET client_id = ?, user_id = ?, gender = ?, yearbirth = ?,telephone=? WHERE client_id = ?";
        $stmt = $connection->prepare($sql);
        $stmt->bind_param("sssii", $user_id, $gender, $yearbirth, $telephone, $client_id);
...
<head>
    ...
    <title>Update About clients</title>
    <script>
...
<center>
    ...
    <form method="POST" onsubmit="return confirmUpdate();">
        ...
        <div>
            ...
            <input readonly class="em" type="text" name="user_id" value="<?php echo $user_id ; ?>">
        </div>
        <div>
            <label for="gender">Gender</label>
            <input class="em"  type="text" name="gender" value="<?php echo $gender; ?>" placeholder="Enter gender">
        </div>
        <div>
            <label for="yearbirth">Year Birth</label>
            <input class="em"  type="text" name="yearbirth" value="<?php echo $yearbirth; ?>" placeholder="Enter year birth">
        </div>
        <div>
